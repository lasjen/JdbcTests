...
public class TraceJDBC {
    ...
    static void create_objects() throws Exception {
        ...
        if (cnt==0) {
            ...
            query = "CREATE TABLE " + TST_TABLE + " as SELECT * FROM user_objects where rownum<=1000";
    ...
    static void drop_objects() throws Exception {
        PreparedStatement ps = null;
        ResultSet rs = null;
        Statement st = conn.createStatement();
        String query;
    ...
    static void trace_on() throws Exception {
        Statement st = conn.createStatement();
        String query;
        System.out.println("-------------------------------------------------------------");
    ...
    static void trace_off() throws Exception {
        Statement st = conn.createStatement();
        String query;
        System.out.println("-------------------------------------------------------------");
    ...
    static void do_test() throws Exception {
        Statement st = conn.createStatement();
        ResultSet rs = null;
        String query;
        System.out.println("-------------------------------------------------------------");
